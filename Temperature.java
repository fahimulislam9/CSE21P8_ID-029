...
public class Temperature extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Temperature", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Broadway", 1, 24), new java.awt.Color(102, 102, 102))); // NOI18N

        a.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        a.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Celcius", "Fahrenheit", "Kelvin" }));
        ...
        b.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Celcius", "Fahrenheit", "Kelvin" }));
    ...
    private void convertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_convertActionPerformed
        // TODO add your handling code here:
         double z;
        double temp = Double.parseDouble(x.getText());
        if (a.getSelectedItem().toString() == "Celcius" && b.getSelectedItem().toString() == "Celcius") {
            z = temp;
            
        } else if (a.getSelectedItem().toString() == "Celcius" && b.getSelectedItem().toString() == "Fahrenheit") {
            z = (temp * (9 / 5) + 32);
            y.setText(String.format("%.3f", z));
        } else if (a.getSelectedItem().toString() == "Celcius" && b.getSelectedItem().toString() == "Kelvin") {
            z = (temp + 273.15);
            y.setText(String.format("%.3f", z));
        } else if (a.getSelectedItem().toString() == "Fahrenheit" && b.getSelectedItem().toString() == "Celcius") {
            z = (temp - 32) * 5 / 9;
            y.setText(String.format("%.3f", z));
        } else if (a.getSelectedItem().toString() == "Fahrenheit" && b.getSelectedItem().toString() == "Fahrenheit") {
            z = (temp);
            y.setText(String.format("%.3f", z));
        } else if (a.getSelectedItem().toString() == "Fahrenheit" && b.getSelectedItem().toString() == "Kelvin") {
            z = (temp - 32) * (5 / 9) + 273.15;
            y.setText(String.format("%.3f", z));
        } else if (a.getSelectedItem().toString() == "Kelvin" && b.getSelectedItem().toString() == "Celcius") {
            z = (temp - 273.15);
            y.setText(String.format("%.3f", z));
        } else if (a.getSelectedItem().toString() == "Kelvin" && b.getSelectedItem().toString() == "Fahrenheit") {
            z = (temp - 273.15) * 9 / 5 + 32;
            y.setText(String.format("%.3f", z));
        } else if (a.getSelectedItem().toString() == "Kelvin" && b.getSelectedItem().toString() == "Kelvin") {
            z = (temp);
